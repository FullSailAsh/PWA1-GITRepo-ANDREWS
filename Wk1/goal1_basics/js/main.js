...
console.log('------ strings ----------');
    ...
    //basic string
    var testString = "He's in PWA1"; //don't have to worry about using escape characters
...
console.log('------ numbers ----------');
    ...
    // arithmetic operators:  +, -, /, *, % (modulo) modulo=remainder of a number
    ...
    //quick operations with "assignment operator" +=, -=, *=, /=, %=
        //myNum = myNum + 5 is the same as myNum += 5
 ...
 ********************************************/
    ...
    console.log("The sum of the array is ", act1[0] + act1[1] + act1[2] + act1[3]);
 ...
 ********************************************/
    ...
    console.log(act2[0] + ", " + act2[1] + ", " + act2[2]);
...
if ("a" < "b"){
    ...
    if ("a" === "a") {
        if ("b" === "b"){
            ...
            //execute block of code if the matching "IF" statement returns
        };
    }else{
 ...
 ********************************************/
    ...
    console.log("Ternary Student1 is: ", student1);
 ...
 ********************************************/
    ...
    var myCounter = function(newct){
      myctr += newct; //same as myctr = myctr + newct
        console.log('counter = ', myctr);
    };
